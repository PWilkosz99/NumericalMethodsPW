...
int main() {
	...
	vector<double> p2 = { 0, 1, 0 };
	vector<double> p3 = { 0, 0, 1 };
	...
	cout << DotProduct2(Q[0], Q[1], make_pair(-1, 1)) << "\n";
	cout << DotProduct2(Q[1], Q[2], make_pair(-1, 1)) << "\n";
	cout << DotProduct2(Q[0], Q[2], make_pair(-1, 1)) << "\n";
	...
	//cout << DotProduct2(Q2[0], Q2[1], make_pair(-1, 1)) << "\n";
	//cout << DotProduct2(Q2[1], Q2[2], make_pair(-1, 1)) << "\n";
	//cout << DotProduct2(Q2[0], Q2[2], make_pair(-1, 1)) << "\n";
}
